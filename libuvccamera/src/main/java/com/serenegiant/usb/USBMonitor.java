...
//			if (DEBUG) Log.i(TAG, "unregister:");
    ...
    public List<UsbDevice> getDeviceList(final DeviceFilter filter) throws IllegalStateException {
        if (destroyed) throw new IllegalStateException("already destroyed");
        final HashMap<String, UsbDevice> deviceList = mUsbManager.getDeviceList();
        Log.e(TAG, "deviceList===: " + deviceList.toString());
        final List<UsbDevice> result = new ArrayList<UsbDevice>();
        if (deviceList != null) {
            for (final UsbDevice device : deviceList.values()) {
...
//		if (DEBUG) Log.v(TAG, "requestPermission:device=" + device);
    ...
    public UsbControlBlock openDevice(final UsbDevice device) throws SecurityException {
        if (hasPermission(device)) {
            ...
            if (result == null) {
                result = new UsbControlBlock(com.serenegiant.usb.USBMonitor.this, device);    // この中でopenDeviceする
    ...
    private final BroadcastReceiver mUsbReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (ACTION_USB_PERMISSION.equals(action)) {
                ...
                synchronized (com.serenegiant.usb.USBMonitor.this) {
    ...
    private final void processConnect(final UsbDevice device) {
        ...
        mAsyncHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (ctrlBlock == null) {
                    ctrlBlock = new UsbControlBlock(com.serenegiant.usb.USBMonitor.this, device);
...
//		if (DEBUG) Log.v(TAG, "getDeviceKeyName:" + sb.toString());
    ...
    public static final class UsbControlBlock implements Cloneable {
         ...
         * @param device
         */
        private UsbControlBlock(final com.serenegiant.usb.USBMonitor monitor, final UsbDevice device) {
...
//			}
        ...
        private UsbControlBlock(final UsbControlBlock src) throws IllegalStateException {
            final com.serenegiant.usb.USBMonitor monitor = src.getUSBMonitor();
        ...
        public com.serenegiant.usb.USBMonitor getUSBMonitor() {
        ...
        public String getDeviceKeyName() {
            return com.serenegiant.usb.USBMonitor.getDeviceKeyName(mWeakDevice.get());
        }
        ...
        public String getDeviceKeyName(final boolean useNewAPI) throws IllegalStateException {
            ...
            return com.serenegiant.usb.USBMonitor.getDeviceKeyName(mWeakDevice.get(), mInfo.serial, useNewAPI);
        }
        ...
        public int getDeviceKey() throws IllegalStateException {
            checkConnection();
            return com.serenegiant.usb.USBMonitor.getDeviceKey(mWeakDevice.get());
        }
        ...
        public int getDeviceKey(final boolean useNewAPI) throws IllegalStateException {
            if (useNewAPI) checkConnection();
            return com.serenegiant.usb.USBMonitor.getDeviceKey(mWeakDevice.get(), mInfo.serial, useNewAPI);
        }
        ...
        public String getDeviceKeyNameWithSerial() {
            return com.serenegiant.usb.USBMonitor.getDeviceKeyName(mWeakDevice.get(), mInfo.serial, false);
        }
        ...
        public synchronized void close() {
            ...
            if (mConnection != null) {
                ...
                mConnection.close();
                mConnection = null;
                final com.serenegiant.usb.USBMonitor monitor = mWeakMonitor.get();
                if (monitor != null) {
